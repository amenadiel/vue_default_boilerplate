...
</code></pre></div>__VP_STATIC_END__`,7);function f(_,w,v,b,T,x){const o=i("ShowCase");return h(),s("div",null,[l,r(o,null,{first_paragraph:t(()=>[g]),second_paragraph:t(()=>[p]),table:t(()=>[m]),_:1}),u])}var z=n(d,[["render",f]]);export{C as __pageData,z as default};
